...
public enum CloudTranscriptionConsent {
    ...
    public static let disclosureMessage = "Before using cloud mode, please allow AIDictation to send your voice recording and generated transcript to AIDictation's cloud transcription service. That service sends the recording to Groq, a third-party AI transcription service, to create the transcript and may use the transcript to apply your selected formatting. Offline mode keeps transcription on this device."
