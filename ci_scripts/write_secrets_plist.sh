...
put_secret "GroqTranscriptionKey" "$(value_from_env GroqTranscriptionKey GROQ_TRANSCRIPTION_KEY GROQ_API_KEY)"
put_secret "GroqLLMKey" "$(value_from_env GroqLLMKey GROQ_LLM_KEY GROQ_API_KEY)"
sentry_dsn="$(value_from_env SENTRY_DSN SentryDSN)"
sentry_dsn_macos="$(value_from_env SENTRY_DSN_MACOS SENTRY_DSN SentryDSN)"
sentry_dsn_ios="$(value_from_env SENTRY_DSN_IOS SENTRY_DSN SentryDSN)"
put_secret "SENTRY_DSN" "$sentry_dsn"
put_secret "SentryDSN" "$sentry_dsn"
put_secret "SENTRY_DSN_MACOS" "$sentry_dsn_macos"
put_secret "SENTRY_DSN_IOS" "$sentry_dsn_ios"
